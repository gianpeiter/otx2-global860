...
enum ReportType_t
{
	...
	enum MagicEffect_t
	{
		...
		MAGIC_EFFECT_ORCSHAMAN = 71,
		MAGIC_EFFECT_ORCSHAMAN_FIRE = 72,
		MAGIC_EFFECT_THUNDER = 73,
		MAGIC_EFFECT_FERUMBRAS = 74,
		MAGIC_EFFECT_CONFETTI_HORIZONTAL = 75,
		MAGIC_EFFECT_CONFETTI_VERTICAL = 76,
		// 77-157 are empty
		MAGIC_EFFECT_BLACKSMOKE = 158,
	...
	enum ShootEffect_t
	{
		...
		// 42-43 are empty
		SHOOT_EFFECT_TARSALARROW = 44,
		SHOOT_EFFECT_VORTEXBOLT = 45,
		// 46-47 are empty
		SHOOT_EFFECT_PRISMATICBOLT = 48,
		SHOOT_EFFECT_CRYSTALLINEARROW = 49,
		SHOOT_EFFECT_DRILLBOLT = 50,
		SHOOT_EFFECT_ENVENOMEDARROW = 51,
