...
class MonsterType
{
	public:
		...
		ItemList createLoot(const LootBlock& lootBlock, double lootBoost = 1.0);
		bool createChildLoot(Container* parent, const LootBlock& lootBlock, uint32_t& money, std::stringstream& str, Player* player, double lootBoost);
