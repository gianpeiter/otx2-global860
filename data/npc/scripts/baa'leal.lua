...
keywordHandler:addKeyword(
	{ "name" },
	StdModule.say,
	{ npcHandler = npcHandler, onlyFocus = true, text = "I'm general Baa'leal. What do you want in Mal'ouquah?" }
)
keywordHandler:addKeyword(
	{ "general" },
	StdModule.say,
...
keywordHandler:addKeyword(
	{ "baa'leal" },
	StdModule.say,
	{ npcHandler = npcHandler, onlyFocus = true, text = "That is GENERAL Baa'leal for you, human." }
)
