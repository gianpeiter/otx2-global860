...
function creatureSayCallback(cid, type, msg)
	...
	if
		(msgcontains(msg, "hi") or msgcontains(msg, "Hello"))
		and (not npcHandler:isFocused(cid))
		and getPlayerStorageValue(cid, 100016) == 1
		and getPlayerStorageValue(cid, 100044) == -1
	then
	...
	if
		(msgcontains(msg, "hi") or msgcontains(msg, "Hello"))
		and (not npcHandler:isFocused(cid))
		and getPlayerStorageValue(cid, 100015) == 1
	then
		npcHandler:say(
			"Wh .. What? How did you get here? Where are all the guards? You .. you could have killed me but yet you chose to talk? What a relief! ...",
			cid
		)
