...
function creatureSayCallback(cid, type, msg)
	...
	elseif Topic[cid] == 1 then
		if msgcontains(msg, "mission") and v == -1 then
	...
	elseif Topic[cid] == 2 then
		if msgcontains(msg, "yes") and v == -1 then
...
function onTradeRequest(cid)
	if getPlayerStorageValue(cid, 100159) < 3 then
...
keywordHandler:addKeyword(
	{ "name" },
	StdModule.say,
	{ npcHandler = npcHandler, onlyFocus = true, text = "My name is none of your business." }
)
keywordHandler:addKeyword(
	{ "alesar" },
	StdModule.say,
	{ npcHandler = npcHandler, onlyFocus = true, text = "That is my name. So what!" }
)
keywordHandler:addKeyword(
	{ "job" },
	StdModule.say,
	{
		...
		onlyFocus = true,
		text = "What does it look like, fool? I'm a guard! But I won't sell you anything until Malor orders me otherwise.",
	}
)
keywordHandler:addKeyword(
	{ "trade" },
	StdModule.say,
	{
		npcHandler = npcHandler,
		onlyFocus = true,
		text = "I won't sell you anything, human. Malor doesn't want me to trade with strangers.",
	}
)
keywordHandler:addKeyword(
	{ "permission" },
...
keywordHandler:addKeyword(
	...
	StdModule.say,
	{
		npcHandler = npcHandler,
		onlyFocus = true,
		text = "Don't you dare mention Daraman in my presence, human. I am through with his insidious lies and through with your accursed race!",
	}
)
keywordHandler:addKeyword(
	{ "djinn" },
...
keywordHandler:addKeyword(
	...
	StdModule.say,
	{
		npcHandler = npcHandler,
		onlyFocus = true,
		text = "We need a strong king to unite us in our struggle against the humans.",
	}
)
keywordHandler:addKeyword(
	{ "tibia" },
	StdModule.say,
	{ npcHandler = npcHandler, onlyFocus = true, text = "One day we djinn will rid this world of evil." }
)
keywordHandler:addKeyword(
	{ "darashia" },
	StdModule.say,
	{
		npcHandler = npcHandler,
		onlyFocus = true,
		text = "I don't care about human cities. If I had my way, they would all be burnt to down today.",
	}
)
keywordHandler:addKeyword(
	{ "edron" },
...
keywordHandler:addKeyword(
	...
	StdModule.say,
	{
		npcHandler = npcHandler,
		onlyFocus = true,
		text = "The pharaoh in Ankrahmun is a dangerous fool. Just your typical human, in other words.",
	}
)
...
keywordHandler:addKeyword(
	...
	StdModule.say,
	{
		npcHandler = npcHandler,
		onlyFocus = true,
		text = "What are you talking about? More human pseudo-philosophical flapdoodle?",
	}
)
keywordHandler:addKeyword(
	{ "rah" },
...
keywordHandler:addKeyword(
	...
	StdModule.say,
	{
		npcHandler = npcHandler,
		onlyFocus = true,
		text = "I like them. They are peaceful, but if they are provoked they fight ferociously. And they are know to eat humans!",
	}
)
keywordHandler:addKeyword(
	{ "kha'zeel" },
	StdModule.say,
	{
		npcHandler = npcHandler,
		onlyFocus = true,
		text = "These mountains are our refuge from those pesky humans. Too bad there are always some who come up here anyway. You, for example.",
	}
)
keywordHandler:addKeyword(
	{ "kha'labal" },
	StdModule.say,
	{
		npcHandler = npcHandler,
		onlyFocus = true,
		text = "The desert Kha'labal was once a beautiful land, but it was devastated in the course of the war. Damn humans! This is all your fault!",
	}
)
keywordHandler:addKeyword(
	{ "melchior" },
	StdModule.say,
	{
		npcHandler = npcHandler,
		onlyFocus = true,
		text = "I remember him. He was a greedy, double-dealing hyena. As far as I know his bleached bones are now lying somewhere in the Kha'labal.",
	}
)
keywordHandler:addKeyword(
	{ "djema" },
	StdModule.say,
	{
		npcHandler = npcHandler,
		onlyFocus = true,
		text = "Djema? Well - I suppose she is the only human I still like. But she has been brought up by djinns. Who knows - perhaps humans can learn.",
	}
)
keywordHandler:addKeyword(
	{ "baa'leal" },
...
keywordHandler:addKeyword(
	{ "bo'ques" },
	StdModule.say,
	{ npcHandler = npcHandler, onlyFocus = true, text = "I miss Bo'ques' cooking, but not his pompous airs and graces." }
)
keywordHandler:addKeyword(
	{ "fa'hradin" },
	StdModule.say,
	{
		npcHandler = npcHandler,
		onlyFocus = true,
		text = "Fa'hradin, that old cynic is way too smart to believe in Daraman's lies. He should reconsider his loyalties.",
	}
)
