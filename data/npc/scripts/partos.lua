...
function creatureSayCallback(cid, type, msg)
	...
	if
		msgcontains(msg, "prison")
		and getPlayerStorageValue(cid, storage) == -1
		and getPlayerStorageValue(cid, 100055) == 1
	then
		npcHandler:say(
			"You mean that's a JAIL? They told me it's the finest hotel in town! THAT explains the lousy roomservice!",
			cid
		)
		Topic[cid] = 1
