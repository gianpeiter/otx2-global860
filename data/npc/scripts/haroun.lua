...
function creatureSayCallback(cid, type, msg)
	...
	if msgcontains(msg, "items") or msgcontains(msg, "change") and getPlayerStorageValue(cid, donestorage) == 8 then
		if getPlayerStorageValue(cid, donestorage) == 8 then
			npcHandler:say(
				"I trade Enchanted Chicken Wind  for Boots of Haste ,Warrior Sweat for 4 Warrior Helmets ,Fighting Spirit for 2 Royal Helmet Magic Sulphur for 3 Fire Swords and Loterry ticket for 100 empty vials",
				cid
			)
		end
...
function onTradeRequest(cid)
	if getPlayerStorageValue(cid, 100159) < 6 then
		npcHandler:say("I'm sorry, but you don't have Gabel's permission to trade with me.", cid)
		return false
	end
...
keywordHandler:addKeyword({ "weapon" }, StdModule.say, {
	...
	onlyFocus = true,
	text = "I'm afraid I do not trade with weapons or armour. Nah'bob only deals with magical equipment.",
})
...
keywordHandler:addKeyword({ "wares" }, StdModule.say, {
	npcHandler = npcHandler,
	onlyFocus = true,
	text = "I only deal with magical equipment. Our range of goods include amulets, rings, wands and some special items.",
})
...
keywordHandler:addKeyword({ "magical" }, StdModule.say, {
	npcHandler = npcHandler,
	onlyFocus = true,
	text = "I only deal with magical equipment. Our range of goods include amulets, rings, wands and some special items.",
})
...
keywordHandler:addKeyword({ "amulet" }, StdModule.say, {
	npcHandler = npcHandler,
	onlyFocus = true,
	text = "I'm selling and buying bronze amulets, stone skin amulets, elven amulets and garlic necklaces.",
})
keywordHandler:addKeyword({ "ring" }, StdModule.say, {
	npcHandler = npcHandler,
	onlyFocus = true,
	text = "I'm selling and buying stealth rings, power rings, sword rings, axe rings, and club rings.",
})
keywordHandler:addKeyword({ "wand" }, StdModule.say, {
	npcHandler = npcHandler,
	onlyFocus = true,
	text = "I'm buying wands of vortex, wands of dragonbreath, wands of plague, wands of cosmic energy and wands of inferno as well as magic light wands.",
})
keywordHandler:addKeyword({ "special" }, StdModule.say, {
	npcHandler = npcHandler,
	onlyFocus = true,
	text = "I'm selling and buying magic light wands. I'm currently also looking for mind stones, life crystals and orbs.",
})
