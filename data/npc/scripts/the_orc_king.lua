...
function greetCallback(cid)
	if
		getPlayerStorageValue(cid, 218) == -1
		and string.lower(getCreatureName(getNpcId())) == string.lower("The Orc King")
	then
...
function creatureSayCallback(cid, type, msg)
	...
	if
		msgcontains(msg, "lamp")
		and getPlayerStorageValue(cid, 9032) == 5
		and getPlayerStorageValue(cid, 100058) == -1
	then
		npcHandler:say(
