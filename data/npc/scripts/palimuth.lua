...
function creatureSayCallback(cid, type, msg)
	...
	elseif msgcontains(msg, "mission") then
		...
		elseif
			getPlayerStorageValue(cid, 100015) >= 1
			and getPlayerStorageValue(cid, 100015) <= 2
			and getPlayerStorageValue(cid, 100046) == -1
		then
		...
		elseif
			getPlayerStorageValue(cid, 100017) == 1
			or getPlayerStorageValue(cid, 100017) == 2 and getPlayerStorageValue(cid, 100047) == -1
		then
		...
		elseif
			getPlayerStorageValue(cid, 100050) == -1 and getPlayerStorageValue(cid, 100021) == 1
			or getPlayerStorageValue(cid, 100021) == 2
			or getPlayerStorageValue(cid, 100021) == 3
		then
		...
		elseif v2 == 14 and getPlayerStorageValue(cid, 100045) == -1 then
			npcHandler:say(
				"Well, what can I say? You have to make a decision. You've seen the differences between my goals and those of Azerus. Make up your mind, but choose wisely!",
				cid
			)
		...
		elseif v == 12 then
			if getPlayerStorageValue(cid, 100051) == 1 then
				...
				npcHandler:say(
					"And if so, is this source still around so that we can use it for the benefit of our city? What really troubles me is that none of those false Yalahari had the personality of a great leader. ...",
					cid,
					6000
				)
				npcHandler:say(
				...
				npcHandler:say(
					"I allow you to enter the Yalaharian treasure room. I'm sure that you can put what you find inside to better use than them. Choose one chest, but think before taking one! ...",
					cid,
					16000
				)
				npcHandler:say(
		...
		elseif v == 13 then
			npcHandler:say(
				"I'm afraid we have not seen the last chapter of Yalahar's drama but I don't have any more missions for you.",
				cid
			)
		end
	--/////////////////////////////////////////Answers///////////////////////////////////////////--
	elseif Topic[cid] == 3 then -- Finish mission 1 - The interrogation
		if msgcontains(msg, "yes") then
			if
				getPlayerStorageValue(cid, 100033) == 1
				and getPlayerStorageValue(cid, 100034) == 1
				and getPlayerStorageValue(cid, 100035) == 1
				and getPlayerStorageValue(cid, 100036) == 1
			then
				npcHandler:say(
	...
	elseif Topic[cid] == 7 then -- Finish mission 1 - The interrogation
		if msgcontains(msg, "yes") then
			if
				getPlayerStorageValue(cid, 9987) == 1
				and getPlayerStorageValue(cid, 9988) == 1
				and getPlayerStorageValue(cid, 9989) == 1
				and getPlayerStorageValue(cid, 9990) == 1
				and getPlayerStorageValue(cid, 9992) == 1
				and getPlayerStorageValue(cid, 9993) == 1
				and getPlayerStorageValue(cid, 9994) == 1
			then
				npcHandler:say(
