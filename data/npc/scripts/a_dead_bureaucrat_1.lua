...
local function greetCallback(cid)
	if getPlayerSex(cid) == PLAYERSEX_FEMALE then
		...
		npcHandler:setMessage(
			MESSAGE_GREET,
			"Hello handsome gentleman, welcome to the atrium of Pumin's Domain. We require some information from you before we can let you pass. Where do you want to go?"
		)
	end
...
local function creatureSayCallback(cid, type, msg)
	...
	elseif
		npcHandler.topic[cid] == 2
		and vocationNames[vocation]
		and msgcontains(msg:lower(), vocationNames[vocation])
	then
