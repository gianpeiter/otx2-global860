function onUse(cid, item, fromPosition, itemEx, toPosition)
	if item.itemid == 1946 and getTileItemById({x = 32220, y = 31845, z = 15}, 1945).uid > 0 and getPlayerStorageValue(cid, 32994) ~= 1 then
		doTransformItem(item.uid, 1945)

		doSendMagicEffect(getThingPos(item.uid), 13)

		doSendMagicEffect({x = 32217, y = 31842, z = 14}, 12)
		doSendMagicEffect({x = 32217, y = 31844, z = 14}, 12)
		doSendMagicEffect({x = 32217, y = 31845, z = 14}, 12)
		doSendMagicEffect({x = 32218, y = 31844, z = 14}, 12)
		doSendMagicEffect({x = 32219, y = 31843, z = 14}, 12)
